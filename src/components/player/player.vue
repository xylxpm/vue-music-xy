      ...
      <div class="normal-player" v-show="fullscreen">
          ...
          <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p :class="{'current' : currentLineNum === index}" ref="lyricLine" class="text"
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right" @click="toggleFavorit(currentSong)">
  ...
  export default {
    ...
    methods: {
      ...
      onProgressBarChange(percent) {
        const _ct = this.currentSong.duration * percent
        this.$refs.audio.currentTime = _ct
        if (!this.playing) {
          this.togglePlaying()
        }
        if (this.currentLyric) {
          this.currentLyric.seek(_ct * 1000)
        }
      },
      format(interval) {
        interval = interval | 0
